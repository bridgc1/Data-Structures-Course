...
Player::Player(int x, int y, char symbol, GameMechs* gm, ItemBin* bin)
{
    ...
    myPos = new objPosDLinkedList();    //simply change list type here to singly/doubly linked lists using Polymophism
    ...
    for(int i = 0; i < TEST_LENGTH; i++) //TEST_LENGTH set to 20 for example here
